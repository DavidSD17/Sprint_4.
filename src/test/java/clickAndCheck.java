...
public class clickAndCheck extends HomePage{
    ...
    public clickAndCheck(By question,By locator, String answer) {
    ...
    public void clickAndCheckMethod() {
        HomePage homePage = new HomePage(driver);
        homePage.clickAndCheck(question,locator,answer);
